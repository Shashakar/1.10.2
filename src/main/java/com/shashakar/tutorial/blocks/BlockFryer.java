package com.shashakar.tutorial.blocks;
...
public class BlockFryer extends Block implements ITileEntityProvider{


	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625 * 4, 0, 0.0625 * 4, 0.0625 * 12, 0.0625 * 7, 0.0625 * 13);
	...
	public BlockFryer(boolean isBurning, String name)
	{
		super(Material.ROCK);
		...
		setUnlocalizedName(Reference.TutorialBlocks.FRYER.getUnlocalizedName());
		setRegistryName(Reference.TutorialBlocks.FRYER.getRegistryName());
	...
	{
		return Item.getItemFromBlock(ModBlocks.fryer);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		else
		{
			...
			{
				playerIn.displayGUIChest((TileEntityFryer)tileentity);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		if (active)
		{
			worldIn.setBlockState(pos, ModBlocks.fryer.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos, ModBlocks.fryer.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		}
		else
		{
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	{
		...
		if (stack.hasDisplayName())
		{
			...
			if (tileentity instanceof TileEntityFryer)
			{
				((TileEntityFryer)tileentity).setCustomInventoryName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	{
		if (!keepInventory)
		{
			...
			if (tileentity instanceof TileEntityFryer)
			{
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityFryer)tileentity);
	...
	{
		return new ItemStack(ModBlocks.fryer);
	}
