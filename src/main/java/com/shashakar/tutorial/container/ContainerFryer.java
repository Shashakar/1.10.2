package com.shashakar.tutorial.container;
...
public class ContainerFryer extends Container {
    ...
    public ContainerFryer(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (FryerRecipes.instance().getFryingResult(itemstack1) != null)
                {
